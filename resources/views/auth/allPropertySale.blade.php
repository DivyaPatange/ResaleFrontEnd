        ...
        <div class="row myrow" id="body-row">
            ...
            <div class="col">
                <div class="container">
                    ...
                    @if(count($propertySale) > 0)
                    <div class="row">   
                        @foreach($propertySale as $p)     
                        <?php
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="card border-secondary">
                                ...
                                <div class="card-body text-secondary ">
                                    ...
                                    <a href="{{ route('property-sale.post.ad', $p->id) }}" class="">Click here to view
                                        <span class="ion-ios-arrow-forward"></span>
                                    </a>
                                    <p class="card-text m-0"> Total Price | <i class="fa fa-inr"></i> {{ $p->total_price }}</p>
                                    </div>
                                </div>
