    ...
    <div class="row">
      <div class="col-md-12">
        <div class="title-single-box">
          ...
          <!--<span class="color-text-a">Resale99 Makes Selling A Tablets An Easy,Guaranteed Purchase. Free Paperwork. Free data Transfer. Free Online Tablets Valuation. Hassle Free Selling. Free Valuation in 10 Sec. Instant Payment. Book An Appointment. Instant Valuation.</span>-->
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="row mt-5">
      <div class="col-sm-12">
        <div class="row">
          <div class="col-md-8">
            <form method="POST" action="{{ url('save-tv-post') }}"  enctype="multipart/form-data" class="p-5 mb-3" style="border:2px solid #114a88;">
            @csrf 
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <select id="product_type" class="form-control @error('product_type') is-invalid @enderror" name="product_type">
                    <option value="">Choose...</option>
                    @foreach($type as $t)
                    <option value="{{ $t->id }}" @if (old('product_type') == $t->id) selected="selected" @endif>{{ $t->type_name }}</option>
                    @endforeach
                  </select>
                  @error('product_type')
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <select name="condition" id="condition" class="form-control @error('condition') invalid-feedback @enderror">
                      <option value="">-Select Condition-</option>
                      <option value="Brand New" @if(old('condition') == "Brand New") Selected @endif>Brand New</option>
                      <option value="Gently Used" @if(old('condition') == "Gently Used") Selected @endif>Gently Used</option>
                      <option value="Heavily Used" @if(old('condition') == "Heavily Used") Selected @endif>Heavily Used</option>
                      <option value="Unboxed" @if(old('condition') == "Unboxed") Selected @endif>Unboxed</option>
                    </select>
                  </div>
                </div>
                @error('condition')
