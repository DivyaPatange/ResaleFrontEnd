                            ...
                            <div class="card border-secondary">
                                ...
                                <div class="card-body text-secondary ">
                                    <div class="card-body p-0" style="font-size:13px">
                                        <p class="card-text m-0">{{ $fashion->ad_title }}</p>
                                    <a href="{{ route('fashion.post.ad', $fashion->id) }}" class="">Click here to view
                                        <span class="ion-ios-arrow-forward"></span>
                                    </a>
                                    <p class="card-text m-0"> Price | <i class="fa fa-inr"></i> {{ $fashion->price }}</p>
                                    </div>
                                </div>
