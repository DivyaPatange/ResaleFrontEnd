            ...
            @csrf 
              ...
              <div class="hidden" id="rent-lease-form">
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-8">
                    <input type="number" class="form-control" id="monthly_rent" name="monthly_rent" onkeyup="show_price.innerHTML=convertNumberToWords(this.value)">
              ...
              <div class="form-group">
                <nav>
                  <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Bedroom</a>
                    <a class="nav-item nav-link" id="nav-about-tab" data-toggle="tab" href="#nav-about" role="tab" aria-controls="nav-about" aria-selected="false">Bathrooms</a>
                    <a class="nav-item nav-link" id="nav-kitchen-tab" data-toggle="tab" href="#nav-kitchen" role="tab" aria-controls="nav-kitchen" aria-selected="false">Kitchen</a>
                    <a class="nav-item nav-link" id="nav-floor-tab" data-toggle="tab" href="#nav-floor" role="tab" aria-controls="nav-floor" aria-selected="false">Floor Plan</a>
                    <a class="nav-item nav-link" id="nav-master-tab" data-toggle="tab" href="#nav-master" role="tab" aria-controls="nav-master" aria-selected="false">Master Plan</a>
                    <a class="nav-item nav-link" id="nav-location-tab" data-toggle="tab" href="#nav-location" role="tab" aria-controls="nav-location" aria-selected="false">Location Map</a>
                    <a class="nav-item nav-link" id="nav-other-tab" data-toggle="tab" href="#nav-other" role="tab" aria-controls="nav-other" aria-selected="false">Others</a>
                  </div>
                </nav>
                <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
