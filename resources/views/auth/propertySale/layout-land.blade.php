...
<div class="form-group">
    <div class="row">
        <div class="col-md-8">
            <label for="">N.A. Sanction<span class="text-danger">*</span><span class="text-danger" id="na_err"></span></label>
        </div>
        <div class="col-md-4">
            <div class="form-check-inline">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="na_sanction" value="Yes">Yes
                </label>
            </div>
            <div class="form-check-inline">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="na_sanction" value="No">No
                </label>
            </div>
        </div>
    </div>
...
<div class="form-group">
    <div class="row">
        <div class="col-md-8">
            <label for="">T.P. Sanction<span class="text-danger">*</span><span class="text-danger" id="tp_err"></span></label>
        </div>
        <div class="col-md-4">
            <div class="form-check-inline">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="tp_sanction" value="Yes">Yes
                </label>
            </div>
            <div class="form-check-inline">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="tp_sanction" value="No">No
                </label>
            </div>
        </div>
    </div>
...
<div class="form-group">
    <div class="row">
        <div class="col-md-8">
            <label for="">Layout Map Sanction<span class="text-danger">*</span><span class="text-danger" id="map_err"></span></label>
        </div>
        <div class="col-md-4">
            <div class="form-check-inline">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="map_sanction" value="Yes">Yes
                </label>
            </div>
            <div class="form-check-inline">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="map_sanction" value="No">No
                </label>
            </div>
        </div>
    </div>
...
<div class="form-group">
    <div class="row">
        <div class="col-md-8">
            <label for="">Demarcation & Road Development Completed<span class="text-danger">*</span><span class="text-danger" id="demarcation_err"></span></label>
        </div>
        <div class="col-md-4">
            <div class="form-check-inline">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="demarcation" value="Yes">Yes
                </label>
            </div>
            <div class="form-check-inline">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="demarcation" value="No">No
                </label>
            </div>
        </div>
    </div>
