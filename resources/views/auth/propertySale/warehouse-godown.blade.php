...
<div class="form-group">
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label for="floor_no">Floor No. <span class="text-danger">*</span><span class="text-danger" id="floor_err"></span></label>
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label for="total_floor">Total Floors <span class="text-danger">*</span><span class="text-danger" id="total_floor_err"></span></label>
...
<div class="form-row">
    ...
    <div class="col-md-7 form-group">
        <div class="switch-field">
            @for($i=1; $i <= 6; $i++)
            <input type="radio"  name="bathroom" id="bath{{ $i }}" value="{{ $i }}" @if(old('bathroom') == $i) checked @endif>
