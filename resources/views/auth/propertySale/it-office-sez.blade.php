  ...
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
        ...
        <select name="bathroom" class="form-control sel-status" id="bathroom">
          <option value="">-Select-</option>
          @for($i=1; $i < 15; $i++)
          <option value="{{ $i }}">{{ $i }}</option>
          @endfor
    ...
    <div class="col-md-6">
      <div class="form-group">
        ...
        <select name="meeting_room" class="form-control sel-status" id="meeting_room">
          <option value="">-Select-</option>
          @for($i=1; $i < 15; $i++)
          <option value="{{ $i }}">{{ $i }}</option>
          @endfor
...
<div class="hidden" id="showDiv">
  ...
  <div class="form-group">
    <label for="">Description<span  style="color:red; display:inline" id="description_err"> </span></label>
