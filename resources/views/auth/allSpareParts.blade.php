...
@section('title', 'Spare Parts Post')
@section('customcss')
<style>
#body-row {
    margin-left:0;
            ...
            <div class="col">
                ...
                <div class="container">
                    <div class="row mt-4">
                        <div class="col-md-12">
                            <div class="title-wrap d-flex justify-content-between">
                                <div class="title-box">
                                <h5 class="title-a">Spare Parts Post</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">   
                        ...
                        <?php
                            $spPhoto = explode(",", $sparePart->photos);
                        ?>               
                        <div class="col-md-3 mb-3">
                            <div class="card border-secondary">
                                <div class="card-header bg-transparent border-secondary ">
                                    <img class="img-fluid myimg" src="{{  URL::asset('adPhotos/' . $spPhoto[0]) }}">
                                </div>
